...
## KPIs (required)
- **Funnel counts/rates** by stage with shared `correlation_id`: captured, qualified, auctioned, sold, unsold, retried, refunded.
...
- **Refund exposure**: refunded leads and refunded cents per day.
...
- Refunded lead ratio > **8%** for 30m => warn.
