...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("status", sa.String(length=32), nullable=False, server_default="pending_replay"),
    ...
    op.create_index("ix_learning_proposals_proposal_date", "learning_proposals", ["proposal_date"])
    op.create_index("ix_learning_proposals_proposal_type", "learning_proposals", ["proposal_type"])
    op.create_index(
        "ix_learning_proposals_source_proposal_id", "learning_proposals", ["source_proposal_id"]
    )
    op.create_index(
